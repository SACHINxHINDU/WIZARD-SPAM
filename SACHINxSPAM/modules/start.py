...
START_OP = [
    [
        Button.url("🦋⃟‌‌‌🇼 ‌ɪᷟᴢᷣᴀʀᴅ 🌸", "https://t.me/hades_wizard"),
        Button.url("ᴜsᴇʀʙᴏᴛ 🕸️", "https://t.me/WIZARD_X_USERBOT")
    ],
    [
...
async def start(event):
    if event.is_private:
        ...
        bot_id = KEX.id
        TEXT = f"**╭────── ˹ ɪɴғᴏʀᴍᴀᴛɪᴏɴ ˼ ⏤͟͟͞͞‌‌‌‌★**\n**┆**\n**┊◍ ʜᴇʏ : [{event.sender.first_name}] **\n**┆◍ ɪ ᴀᴍ : [{bot_name}](tg://user?id={bot_id}) **\n**┊**\n**┆● ɴxᴛ ʙᴏᴛ ᴠᴇʀsɪᴏɴ :** `0.2`\n**┊● ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ :** `8.2.5.1.01`\n**╰─────────────────────────**\n**──────────────────────────**\n**⦿ Oᴡɴᴇʀ - [🦋⃟‌‌‌🇼 ‌ɪᷟᴢᷣᴀʀᴅ 🌸](https://t.me/hades_wizard) **\n**──────────────────────────**\n**    ❖ Uᴘᴅᴀᴛᴇ's ⏤͟͟͞͞‌‌‌‌ [❖ ∣ 𝐖ɪᴢʌꝛᴅ Tᴇᴄʜ ∣ ❖ ](https://t.me/+4RrKR7dlOwxjNWJl) **\n**──────────────────────────**"
